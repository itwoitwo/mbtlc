<ul class="nav nav-pills nav-justified mb-3 border border-primary rounded">
    ...
    <li class="nav-item border-left border-right border-primary"><a href="{{ route('favorites.favorites_index', ['id' => $user->id]) }}" class="nav-link {{ request()->route()->named('favorites*') ? 'active' : '' }}">お気に入り</a></li>
